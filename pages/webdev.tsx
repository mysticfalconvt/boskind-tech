...
export default function page() {
  return (
    ...
    <div className="hero mt-10 ">
      <div className="hero-content flex-col lg:flex-row border-r-4 glass text-base-content m-2 rounded-md max-w-6xl">
        <img
          src="/images/NorthCountryCool.png"
          className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg rounded-lg shadow-2xl"
        />
        <div>
          <h1 className="text-5xl font-bold">{copy.components.webdev.title}</h1>
